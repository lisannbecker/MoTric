...
class social_transformer(nn.Module):
	def __init__(self, past_len): #only issue, incorrect past_len = setting this to 8 fixes it
		# print(past_len)
		# exit()
		super(social_transformer, self).__init__()
		self.encode_past = nn.Linear(past_len*6, 256, bias=False) #likely the problem
